...
private:
	TextRenderer();
	void					TextRendererPrintf( const float cellHeight, const Vec2f& screenPosition, const Rgba& color, const unsigned int shaderProgramID, const char* text, va_list args );
